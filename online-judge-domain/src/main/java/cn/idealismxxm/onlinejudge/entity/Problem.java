...
public class Problem implements java.io.Serializable {
    ...
    public Problem(Integer id, java.util.Date updatedTime, Integer timeLimit, Integer publicStatus, Integer memoryLimit, String title, Integer originalOj, String originalId, String url) {
        super();
        this.id = id;
